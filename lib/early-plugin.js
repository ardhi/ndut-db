...
module.exports = fp(async function (fastify, options) {
  ...
  fastify.decorate('ndutDb', {
    ds,
    model,
    helper,
    exec: exec.bind(fastify),
    find: find.bind(fastify),
    findOne: findOne.bind(fastify),
    findById: findById.bind(fastify),
    create: create.bind(fastify),
    update: update.bind(fastify),
    remove: remove.bind(fastify),
    count: count.bind(fastify)
  })
})
